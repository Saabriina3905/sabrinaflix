...
const Games = () => {
  ...
  useEffect(() => {
    // For games, we'll use action/adventure movies as a placeholder
    // In a real app, you'd integrate with a games API
    fetch(
      "https://api.themoviedb.org/3/discover/movie?language=en-US&with_genres=28&sort_by=popularity.desc&page=1",
      options
    )
      .then((res) => res.json())
      .then((res) => {
  ...
  return (
    <div className="min-h-screen bg-[#181818] text-white p-5">
      <h1 className="text-3xl font-bold mb-5">Games & Interactive Content</h1>
      <p className="text-gray-400 mb-5">
        Explore action-packed content and interactive experiences
      </p>
